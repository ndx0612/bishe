...
let saveStateKeys = ['vuex_user', 'vuex_token', 'vuex_userId','vuex_userName','vuex_Avatar','vuex_code','vuex_score'];
...
const store = new Vuex.Store({
	...
	state: {
		...
		vuex_code: lifeData.vuex_code ? lifeData.vuex_code : '-1',
		vuex_phone: lifeData.vuex_phone ? lifeData.vuex_phone : '',
		vuex_score: lifeData.vuex_score ? lifeData.vuex_score : '',
	},
	mutations: {
